...
Retention is critically low, 85%+ of donors do not return after the first donation
Revenue is concentrated in a small group of high-value donors
Channel quality differs significantly:
  *Google Ads → high LTV, low scale
  *Facebook Ads → high volume, lower quality
Campaign performance varies:
  *Food → stable and scalable
  *Education → highest ROI
  *Emergency → low efficiency
...
* End-to-end data workflow (API → BI)
